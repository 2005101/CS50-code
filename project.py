...
def main():
    birthday, birthmonth, birthyear = is_valid(input("Enter Birthdate: ").lower())
    today = date.today()
    age = calculate_age(birthday, int(birthmonth), int(birthyear), today)
    days = calculate_days(birthday, int(birthmonth), today)
